...
//
//describe("LinkedList contract", () => {
//
//  let NestedLinkedList
//  let instance
//  let res
//  let alice
//  let bob
...
//
//  before(async() => {
//    NestedLinkedList = await ethers.getContractFactory("NestedLinkedList");
...
//        let numPet = await instance.getNumOperators(1)
...
//        numPet = await instance.getNumOperators(1)
